package bhs.devilbotz.networkalerts;
 ...
 */
@Description(group = "bhs.devilbotz", name = "NetworkAlerts", version = "1.2.0", summary = "A plugin for displaying persistent alerts sent over NetworkTables.")
